...
<img src="https://github.com/gowizzard/dotfiles/assets/30717818/25db37be-0b6c-44b5-8cd2-787b53dbe82c" alt="dotfiles" width="650" style="margin:50px 0;">
...
```text
xorg, xorg-xinit, i3, dmenu, dex, kwallet5, pulseaudio-alsa, pulseaudio-bluetooth, pulseaudio-equalizer, pulseaudio-jack, pulseaudio-lirc, pasystray, nfs-utils, feh, kitty, zsh, git, make, tmux, neovim, chromium, firefox, go, python, npm, terraform, ansible, jq, neofetch, thunar, obsidian, gimp, vlc
```
...
```text
xorg, xinit, i3, dmenu, dex, kwalletmanager, feh, kitty, zsh, git, make, tmux, neovim, chromium, jq, neofetch, thunar, gimp, vlc
``` 
