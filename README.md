...
<img src="https://github.com/gowizzard/dotfiles/assets/30717818/df08bcbe-9cf7-40e3-bee7-9ed69e1b8425" alt="dotfiles" width="650" style="margin:50px 0;">
...
```text
xorg, xorg-xinit, i3, dmenu, dex, kwallet5, nfs-utils, feh, kitty, zsh, git, make, tmux, neovim, chromium, firefox, go, python, npm, terraform, ansible, jq, neofetch, thunar, obsidian, gimp, vlc
```
